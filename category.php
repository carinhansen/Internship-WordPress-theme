...
?>
    <div class="container">
        <div class="cat-title">
            ...
            <span>Dit is een overzicht van alle bewijsmateriaal voor de competentie "<?php single_term_title(); ?>
                ".</span>
        </div>
        <?php if (have_posts()) : ?>
            <?php while (have_posts()) : the_post(); ?>
                <div class="post-container">
                    ...
                    <div class="post-text">
                        <a href="<?php the_permalink(); ?>" class="category-title-link"><h4><?php the_title(); ?></h4>
